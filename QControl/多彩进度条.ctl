...
Begin VB.UserControl 进度条 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   295
   ToolboxBitmap   =   "多彩进度条.ctx":0000
End
Attribute VB_Name = "进度条"
...
Public Property Let 颜色(ByVal NewValue As U_Themes)
Attribute 颜色.VB_Description = "Progressbar Styles."
...
Public Property Get 颜色() As U_Themes
    颜色 = U_Theme
End Property

Public Property Let 百分号样式(ByVal NewValue As U_TextStyles)
Attribute 百分号样式.VB_Description = "Progressbar Text Style."
    U_TextStyle = NewValue
    PropertyChanged "百分号样式"
    Bar_Draw
End Property
Public Property Get 百分号样式() As U_TextStyles
    百分号样式 = U_TextStyle
End Property


Public Property Get 色块显示() As U_OrientationsS
    色块显示 = U_Orientation
End Property

Public Property Let 色块显示(ByVal NewValue As U_OrientationsS)
    U_Orientation = NewValue
    PropertyChanged "色块显示"
    Bar_Draw
End Property

Public Property Get 文本位置() As U_TextAlignments
Attribute 文本位置.VB_Description = "Progressbar Text Alignment."
    文本位置 = U_TextAlign
End Property

Public Property Let 文本位置(ByVal NewValue As U_TextAlignments)
...
Public Property Get 文本样式() As U_TextEffects
Attribute 文本样式.VB_Description = "Progressbar Text Effect."
    文本样式 = U_TextEffect
End Property

Public Property Let 文本样式(ByVal NewValue As U_TextEffects)
    U_TextEffect = NewValue
    PropertyChanged "文本样式"
    Bar_Draw
End Property
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        颜色 = .ReadProperty("Theme", 1)
        百分号样式 = .ReadProperty("TextStyle", 1)
        色块显示 = .ReadProperty("Orientations", Horizontal)
        Text = .ReadProperty("Text", Ambient.DisplayName)
        TextEffectColor = .ReadProperty("TextEffectColor", RGB(200, 200, 200))
        文本样式 = .ReadProperty("TextEffect", 1)
        文本位置 = .ReadProperty("TextAlignment", 5)
...
Private Sub Bar_Draw()
    ...
    If 色块显示 = Vertical Then q = (Y * UserControl.ScaleHeight / 100)
    ...
    If 百分号样式 = PBValue Then
        DrawCaptionText Value, U_TextAlign
    ElseIf 百分号样式 = PBPercentage Then
        DrawCaptionText Y & "%", U_TextAlign
    ElseIf 百分号样式 = CustomText Then
        DrawCaptionText U_Text, U_TextAlign
    ElseIf 百分号样式 = PBNoneText Then
    End If
End Sub
