...
Public Function Attach(ByVal hwnd As Long) As Long
    ...
    Exit Function
Err:
    QDB.Runtime_Error "Mod_QHookSkin->Attach", Err.Description, Err.Number
    Resume Next
End Function
...
Public Function Detach(ByVal hwnd As Long) As Long
    ...
    Exit Function
Err:
    QDB.Runtime_Error "Mod_QHookSkin->Detach", Err.Description, Err.Number
    Resume Next
End Function
